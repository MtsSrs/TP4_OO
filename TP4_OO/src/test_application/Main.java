...
//	public static ArrayList<Estoque> estoquePastel;
//	public static ArrayList<Estoque> estoqueBebida;
...
//		estoquePastel = new ArrayList<Estoque>();
//		estoqueBebida = new ArrayList<Estoque>();
...
//
//		estoquePastel.add(10);
//		estoquePastel.add(20);
//		estoquePastel.add(30);
//		estoqueBebida.add(30);
//		estoqueBebida.add(40);
//		estoqueBebida.add(50);
//		
//		vendas.add(new Venda(1, clientes.get(0), (float) 18.98, pasteis.get(0), bebidas.get(0)), estoquePastel);
//		vendas.add(new Venda(2, clientes.get(1), (float) 21.98, pasteis.get(1), bebidas.get(1)));
//		
//		mensagemBoasVindas();
//
//		do {
